...
TENSES_ANNOTATED_NOINF = WD_ANNOTATE + "\\tenses_annotated_noinf" #csv 
TENSES_ANNOTATED_NOINF_CLEAN = WD_ANNOTATE + "\\tenses_annotated_noinf_clean" #csv
TENSES_ANNOTATED_CLEAN_N = WD_ANNOTATE + "\\tenses_annotated_noinf_clean_" #csv
...
PREPDAT_FILES = [TENSES, TENSES_WITH_INF, TENSES_WITH_INF_NEW, TENSES_ONE_SENT_PER_VERB,
                 TENSES_ONE_SENT_PER_VERB_WITH_MODALS, TENSES_ONE_SENT_PER_VERB_READY_GZ, TENSES_ONE_SENT_PER_VERB_SHUF_GZ,
...
TARGETS = WD_EXTRACT_NGRAM + "ngrams_touse.csv"
